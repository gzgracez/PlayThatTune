...
public class MusicTestNew {
	 ...
	 */
	public static short selectNoteTune(short key, short qual) {
	 ...
	 */
	public static short selectNoteBase(int build) {
		int midindex;
		int lowindex;
	...
	public static int chordQuality(int b) {//b is always negative
	 ...
	 */
	public static double[] genRhythms(double quarterNote) {
	 ...
	 */
	public static int[] genChorus(short chorusLength) {
